...
<div class="product-view">
    ...
    <div class="content with-padding padding-bottom-0">
        <div class="row">
            <div class="col-md-6">
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Main'); ?></strong></h3>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
                        [
                ...
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Name and description'); ?></strong></h3>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
                        'name_uz',
                ...
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Price && Cost'); ?></strong></h3>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
                        'actual_price',
            ...
            <div class="col-md-6">
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Rasm va videolar'); ?></strong></h3>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
                        [
                ...
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Similar'); ?></strong></h3>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
                        [
                ...
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Product options'); ?></strong></h3>
                ...
                <h3 style="margin-bottom: 10px;"><strong><?= Yii::t('app', 'Статистика'); ?></strong></h3>
                <?= DetailView::widget([
                    'model' => $model,
                    'attributes' => [
                        [
