...
class LangUrlManager extends BaseUrlManager
{
    ...
    public function parseRequest($request)
    {
        ...
        if (isset(Yii::$app->session[$this->languageSessionKey]) && in_array(Yii::$app->session[$this->languageSessionKey], $this->languages))
            Yii::$app->language = Yii::$app->session[$this->languageSessionKey];
        elseif (isset($cookies[$this->languageCookieName]) && in_array($cookies[$this->languageCookieName], $this->languages))
            Yii::$app->language = $cookies[$this->languageCookieName];
        if (isset($_GET[$this->languageParam]) && in_array($_GET[$this->languageParam], $this->languages)){
            Yii::$app->language = $_GET[$this->languageParam];
            $this->persistLanguage($_GET[$this->languageParam]);
            unset($_GET[$this->languageParam]);
        }
    ...
    protected function loadPersistedLanguage()
    {
        ...
        if ($language === null && $this->_request) {
