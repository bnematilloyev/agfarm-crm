...
return [
    ' and ' => ' va ',
    '"{attribute}" does not support operator "{operator}".' => '"{attribute}" "{operator}" operatorini qo\'llab-quvvatlamaydi.',
    '(not set)' => '(qiymatlanmagan)',
    'Action not found.' => 'Harakat topilmadi.',
    'Aliases available: {aliases}' => 'Yo`l mavjud: {aliases}',
    ...
    'Condition for "{attribute}" should be either a value or valid operator specification.' => ' "{attribute}" sharti yoki qiymat yoki operatorning haqiqiy spetsifikatsiyasi bo\'lishi kerak. ',
    'Delete' => 'O`chirish',
    'Error' => 'Xato',
    ...
    'Operator "{operator}" must be used with a search attribute.' => '"{operator}" operatori qidiruv atributi bilan ishlatilishi kerak.',
    'Operator "{operator}" requires multiple operands.' => '"{operator}" operatoriga bir nechta operand kerak bo\'ladi.',
    'Options available: {options}' => 'Tanlovlar mavjud: {options}',
    ...
    'The combination {values} of {attributes} has already been taken.' => '{atributlar} ning {qiymatlari} kombinatsiyasi allaqachon qabul qilingan.',
    ...
    'The format of {filter} is invalid.' => '{filter} formati noto\'g\'ri.',
    ...
    'Unknown alias: -{name}' => 'Noma\'lum yo`l: - {name}',
    'Unknown filter attribute "{attribute}"' => '"{attribute}" noma\'lum filtr atributi',
    ...
    'You should upload at least {limit, number} {limit, plural, one{file} other{files}}.' => 'Kamida {limit, number} {limit, plural, one{file} other{files}} yuklashingiz kerak.',
    ...
    '{attribute} contains wrong subnet mask.' => '{attribute} tarkibida quyi tarmoq maskasi mavjud emas.',
    ...
    '{attribute} is not in the allowed range.' => '{attribute} ruxsat etilgan doirada emas.',
    ...
    '{attribute} must be a valid IP address.' => '{attribute} haqiqiy IP-manzil bo\'lishi kerak.',
    '{attribute} must be an IP address with specified subnet.' => '{attribute} ko\'rsatilgan IP-manzil bo\'lishi kerak.',
    ...
    '{attribute} must be greater than "{compareValueOrAttribute}".' => '{attribute} "{compareValueOrAttribute}" dan kattaroq bo\'lishi kerak.',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => '{attribute} "{compareValueOrAttribute}" dan katta yoki unga teng bo\'lishi kerak.',
    '{attribute} must be less than "{compareValueOrAttribute}".' => '{attribute} "{compareValueOrAttribute}" dan kichikroq bo\'lishi kerak.',
    '{attribute} must be less than or equal to "{compareValueOrAttribute}".' => '{attribute} "{compareValueOrAttribute}" dan kam yoki unga teng bo\'lishi kerak.',
    ...
    '{attribute} must not be a subnet.' => '{attribute} pastki tarmoq bo\'lmasligi kerak.',
    '{attribute} must not be an IPv4 address.' => '{attribute} IPv4 manzili bo\'lmasligi kerak.',
    '{attribute} must not be an IPv6 address.' => '{attribute} IPv6 manzili bo\'lmasligi kerak.',
    ...
    '{delta, plural, =1{1 day} other{# days}}' => '{delta, plural, =1{1 day} other{# kun}}',
    '{delta, plural, =1{1 hour} other{# hours}}' => '{delta, plural, =1{1 hour} other{# soat}}',
    '{delta, plural, =1{1 minute} other{# minutes}}' => '{delta, plural, =1{1 minute} other{# minut}}',
    '{delta, plural, =1{1 month} other{# months}}' => '{delta, plural, =1{1 month} other{# oy}}',
    '{delta, plural, =1{1 second} other{# seconds}}' => '{delta, plural, =1{1 second} other{# sekund}}',
    '{delta, plural, =1{1 year} other{# years}}' => '{delta, plural, =1{1 year} other{# yil}}',
    ...
    'Powered by {yii}' => '@@{yii} tomonidan qo\'llab quvvatlanadi@@',
    'Yii Framework' => '@@Yii freymvorki@@',
    '{percent}% Complete' => '@@{percent}% To`ldi@@',
];
