...
class PageSize extends \yii\base\Widget
{
     ...
     */
    public $label = 'sahifadagi elementlar soni';
    ...
    public function run()
    {
        ...
        $this->options['style'] = 'width: auto; display: inline-block;';
        $this->labelOptions['style'] = 'display: inline-block;margin-left: 20px;';
