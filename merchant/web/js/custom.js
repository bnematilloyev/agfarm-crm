...
document.addEventListener('DOMContentLoaded', function () {
    ...
    emptyContainer.className = "emptysz";
    ...
    imgElement.src = '/images/Folder.svg';
...
document.addEventListener('DOMContentLoaded', function () {
    let buttons = document.querySelectorAll('.status_button-new .button');
    let currentUrl = window.location.href;
    let queryString = currentUrl.split('?')[1];

    buttons.forEach(function (button) {
        let hrefValue = button.getAttribute('href');
        let statusButton = hrefValue.split('?')[1];

        if (statusButton && statusButton === queryString) {
